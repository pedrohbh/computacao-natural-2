...
def es_comma(objective, bounds, n_iter, step_size, mu, lam, x_dados, y_dados):
	...
	return [best, best_eval, n_geracoes, valor_otimo_geracao]
...
best, score, n_geracoes, valor_otimo_geracao = es_comma(f, bounds, n_iter, step_size, mu, lam, x_train, y_train)
print('Done!')
