...
def es_comma(objective, bounds, n_iter, step_size, mu, lam, x_dados, y_dados):
	...
	for epoch in range(n_iter):
		...
		population = children
		valor_otimo_geracao.append(best_eval)
	return [best, best_eval, n_geracoes, valor_otimo_geracao, n_iteracoes]
...
best, score, n_geracoes, valor_otimo_geracao, n_iteracoes = es_comma(f, bounds, n_iter, step_size, mu, lam, x_train.to_numpy(), y_train.to_numpy())
print('Done!')
...
n_iteracoes = np.array(n_iteracoes)
#print(n_geracoes)
...
plt.title("Convergência")
plt.plot(n_iteracoes, valor_otimo_geracao, "--")
